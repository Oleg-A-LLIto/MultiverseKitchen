...
{
    public List<ConfigurableJoint> m_MonitoredJoints;
    public List<GameObject> JointObjects;

    void Start()
    {
        m_MonitoredJoints = new List<ConfigurableJoint>();
        JointObjects = new List<GameObject>();
        GetComponents<ConfigurableJoint>(m_MonitoredJoints);
    }

    public void MonitorNew(ConfigurableJoint newJ)
    {
